const apiKey = "063a1dd2fe76657bc6149206a2e2d78d";
...
async function checkWeather(city) {
	...
	if (response.status == 404) {
		...
		if (data.weather[0].main == "Clouds")weatherIcon.src="./images/cloud.png"
		...
		else if (data.weather[0].main == "Haze")weatherIcon.src = "./images/mist.png";
